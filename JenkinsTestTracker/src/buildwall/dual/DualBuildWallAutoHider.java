 ...
 * the individual {@link buildwall.layout.GridWallImpl}s in the {@link DualBuildWallDisplayImpl}.
 */
public class DualBuildWallAutoHider {
    ...
    * @param leftEmpty empty property for the left {@link buildwall.layout.GridWallImpl}.
    * @param rightEmpty empty property for the right {@link buildwall.layout.GridWallImpl}.
    */
