...
public class JobDetailsParserTest {
   ...
   @Test public void shouldParseSampleDataIntoDatabase() {
      ...
      assertThat( dansProject.currentBuildNumberProperty().get(), is( 0 ) );
      assertThat( dansProject.currentBuildTimeProperty().get(), is( 0L ) );
      assertThat( dansProject.currentBuildTimestampProperty().get(), is( 1481218445438L ) );
      ...
      assertThat( lizsProject.currentBuildNumberProperty().get(), is( 0 ) );
      assertThat( lizsProject.currentBuildTimeProperty().get(), is( 0L ) );
      assertThat( lizsProject.currentBuildTimestampProperty().get(), is( 1481218487257L ) );
      ...
      assertThat( jeffsProject.currentBuildTimestampProperty().get(), is( 0L ) );
