 ...
 */
public class SimpleJobPanelDescriptionImplTest {

   private JenkinsJob job;
   private BuildWallConfiguration configuration; 
   private SimpleJobPanelDescriptionImpl systemUnderTest;
   ...
   @Test public void propertiesShouldBeSlightlyTransparent(){
      Assert.assertEquals( SimpleJobPanelDescriptionImpl.DEFAULT_PROPERTY_OPACITY, systemUnderTest.buildNumber().getOpacity(), TestCommon.precision() );
      Assert.assertEquals( SimpleJobPanelDescriptionImpl.DEFAULT_PROPERTY_OPACITY, systemUnderTest.completionEstimate().getOpacity(), TestCommon.precision() );
   }//End Method
   ...
   @Test public void shouldUseJobNumberAndKeepUpdated(){
      Assert.assertEquals( 
               SimpleJobPanelDescriptionImpl.formatBuildNumberAndTimestamp( job.lastBuildNumberProperty().get(), job.lastBuildTimestampProperty().get() ), 
      ...
      Assert.assertEquals( 
               SimpleJobPanelDescriptionImpl.formatBuildNumberAndTimestamp( value, job.lastBuildTimestampProperty().get() ),
               systemUnderTest.buildNumber().getText() 
      );
      ...
      Assert.assertEquals( 
               SimpleJobPanelDescriptionImpl.formatBuildNumberAndTimestamp( job.lastBuildNumberProperty().get(), timestamp ),
               systemUnderTest.buildNumber().getText() 
      );
   }//End Method
   ...
   @Test public void shouldUseJobBuildTimeAndKeepUpdated(){
      Assert.assertEquals( 
               SimpleJobPanelDescriptionImpl.formatCompletionEstimateInMilliseconds( 
   ...
   @Test public void shouldFormatBuildNumber(){
      Assert.assertEquals( "#2001", SimpleJobPanelDescriptionImpl.formatBuildNumber( 2001 ) );
      Assert.assertEquals( "#?", SimpleJobPanelDescriptionImpl.formatBuildNumber( null ) );
   }//End Method
   
   @Test public void shouldFormatBuildNumberAndTimestamp(){
      assertThat( 
               "#200 | 08:59-17/01", 
               is( SimpleJobPanelDescriptionImpl.formatBuildNumberAndTimestamp( 200, 1457963846l ) ) 
      );
      assertThat( 
               "#? | ?-?", 
               is( SimpleJobPanelDescriptionImpl.formatBuildNumberAndTimestamp( null, null ) ) 
      );
   }//End Method
   
   @Test public void shouldProvideCorrectDateTimeFormat(){
      assertThat( SimpleJobPanelDescriptionImpl.formatTimestamp( 1457963846l ), is( "08:59-17/01" ) );
      assertThat( SimpleJobPanelDescriptionImpl.formatTimestamp( null ), is( "?-?" ) );
   }//End Method
   
   @Test public void shouldFormatCompletionEstimateInSeconds(){
      Assert.assertEquals( "1m 30s | 2m 0s", SimpleJobPanelDescriptionImpl.formatCompletionEstimateInSeconds( 90, 120 ) );
      Assert.assertEquals( "5m 0s | 1m 0s", SimpleJobPanelDescriptionImpl.formatCompletionEstimateInSeconds( 300, 60 ) );
   }//End Method
   
   @Test public void shouldFormatCompletionEstimateInMilliseconds(){
      Assert.assertEquals( "1m 30s | 2m 0s", SimpleJobPanelDescriptionImpl.formatCompletionEstimateInMilliseconds( 90000, 120000 ) );
      Assert.assertEquals( "5m 0s | 1m 0s", SimpleJobPanelDescriptionImpl.formatCompletionEstimateInMilliseconds( 300000, 60000 ) );
   }//End Method
   
   @Test public void shouldFormatMillisecondsIntoMinutesAndSeconds(){
      Assert.assertEquals( "1m 30s", SimpleJobPanelDescriptionImpl.formatMillisecondsIntoMintuesAndSeconds( 90000 ) );
      Assert.assertEquals( "2m 0s", SimpleJobPanelDescriptionImpl.formatMillisecondsIntoMintuesAndSeconds( 120000 ) );
      Assert.assertEquals( "0m 0s", SimpleJobPanelDescriptionImpl.formatMillisecondsIntoMintuesAndSeconds( 0 ) );
   }//End Method
