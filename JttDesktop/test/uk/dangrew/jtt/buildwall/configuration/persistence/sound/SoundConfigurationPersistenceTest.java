...
import static uk.dangrew.jtt.buildwall.configuration.persistence.sound.SoundConfigurationPersistence.CURRENT_STATE;
import static uk.dangrew.jtt.buildwall.configuration.persistence.sound.SoundConfigurationPersistence.EXCLUSION_JOB_NAME;
import static uk.dangrew.jtt.buildwall.configuration.persistence.sound.SoundConfigurationPersistence.FILENAME;
import static uk.dangrew.jtt.buildwall.configuration.persistence.sound.SoundConfigurationPersistence.JOB_EXCLUSIONS;
import static uk.dangrew.jtt.buildwall.configuration.persistence.sound.SoundConfigurationPersistence.PREVIOUS_STATE;
import static uk.dangrew.jtt.buildwall.configuration.persistence.sound.SoundConfigurationPersistence.SOUND;
import static uk.dangrew.jtt.buildwall.configuration.persistence.sound.SoundConfigurationPersistence.STATUS_CHANGES;
