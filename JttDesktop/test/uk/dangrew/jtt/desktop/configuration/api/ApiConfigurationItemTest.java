...
public class ApiConfigurationItemTest {
   ...
   private ApiConfigurationItem systemUnderTest;
   
   @Before public void initialiseSystemUnderTest(){
      TestApplication.startPlatform();
      MockitoAnnotations.initMocks( this );
      systemUnderTest = new ApiConfigurationItem( controller );
   }//End Method
   ...
   @Test public void shouldHandleClickByInstructingController() {
      ...
      assertThat( title.getTitle(), is( ApiConfigurationItem.TITLE ) );
      assertThat( title.getDescription(), is( ApiConfigurationItem.DESCRIPTION ) );
      
      assertThat( contentCaptor.getValue(), is( instanceOf( ScrollPane.class ) ) );
      ScrollPane scroller = ( ScrollPane ) contentCaptor.getValue();
      assertThat( scroller.getContent(), is( instanceOf( ApiConfigurationPanel.class ) ) );
   }//End Method
   
   @Test public void shouldProvideToStringUsingName(){
      assertThat( systemUnderTest.toString(), is( ApiConfigurationItem.NAME ) );
   }//End Method
